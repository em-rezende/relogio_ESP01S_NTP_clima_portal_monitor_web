...
// Defina ROTATE conforme seu display: 0, 90, ou 270
// Baseado no seu código antigo que funciona
#define ROTATE 90  // <-- Seu código antigo tinha ROTATE 90

// VARIÁVEL scr DEFINIDA AQUI (não extern)
byte scr[NUM_MAX * 8 + 8] = {0};
